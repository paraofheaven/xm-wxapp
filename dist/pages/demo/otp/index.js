...
var OtpDemo = (_temp2 = _class = function (_BaseComponent) {
  ...
  function OtpDemo() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OtpDemo.__proto__ || Object.getPrototypeOf(OtpDemo)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__15"], _this.sendRequest = function () {
