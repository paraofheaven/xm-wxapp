...
var Demo = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Demo() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Demo.__proto__ || Object.getPrototypeOf(Demo)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__167", "$compid__168", "$compid__169", "$compid__170", "$compid__171", "bottomupOpen", "value1"], _this.config = {
    ...
    }, _this.handleOtpClick = function (e) {}, _this.customComponents = ["AtButton", "AtForm", "AtInput", "Otp", "BottomUp", "KeyBoard", "AtMessage"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Demo, [{
    ...
    value: function _createData() {
      ...
      var $compid__171 = (0, _index.genCompid)(__prefix + "$compid__171");
      ...
      _index.propsManager.set($props__169, $compid__169);
      _index.propsManager.set($props__170, $compid__170);
      _index.propsManager.set($props__171, $compid__171);
