...
var PwdBoxDemo = (_temp2 = _class = function (_BaseComponent) {
  ...
  function PwdBoxDemo() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PwdBoxDemo.__proto__ || Object.getPrototypeOf(PwdBoxDemo)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__244"], _this.onPwdInputFinish = function (value) {
  ...
  _createClass(PwdBoxDemo, [{
    ...
    value: function _createData() {
      ...
      ;
      var $compid__244 = (0, _index.genCompid)(__prefix + "$compid__244");
      var $props__244 = {
        "onInputFinish": this.onPwdInputFinish
      };
      _index.propsManager.set($props__244, $compid__244);
