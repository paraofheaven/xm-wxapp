...
var PwdBoxDemo = (_temp2 = _class = function (_BaseComponent) {
  ...
  function PwdBoxDemo() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PwdBoxDemo.__proto__ || Object.getPrototypeOf(PwdBoxDemo)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__18"], _this.onPwdInputFinish = function (value) {
