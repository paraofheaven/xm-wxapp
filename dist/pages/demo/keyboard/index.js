...
var KeyboardDemo = (_temp2 = _class = function (_BaseComponent) {
  ...
  function KeyboardDemo() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = KeyboardDemo.__proto__ || Object.getPrototypeOf(KeyboardDemo)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__13", "$compid__14", "value1"], _this.handleChange = function (value) {
      _this.setState({
        value1: value
      });
