...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray27", "$compid__316", "scrollIntoView", "current"], _this.config = {
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      ;
      var $compid__316 = (0, _index.genCompid)(__prefix + "$compid__316");
      ...
      var loopArray27 = ['', ''].map(function (em, index) {
        em = {
      ...
      _index.propsManager.set($props__316, $compid__316);
