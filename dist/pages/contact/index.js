...
var Source = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Source() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Source.__proto__ || Object.getPrototypeOf(Source)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__40", "isActionOpened"], _this.config = {
