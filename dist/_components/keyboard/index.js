...
var KeyBoard = (_temp2 = _class = function (_BaseComponent) {
  ...
  function KeyBoard() {
    ...
    }, _this.handleKeyboradClear = function () {
      _this.props.onKeyboradClear();
  ...
  _createClass(KeyBoard, [{
    ...
    value: function _constructor() {
      ...
      this.defaultProps = {
        hideFinishBtn: false,
        onKeyboradClear: function onKeyboradClear() {},
  ...
  return KeyBoard;
}(_index.Component), _class.$$events = ["handleKeyboradClear", "handleKeyboradFinish", "handleKeyboradNumber", "shffuleBoard"], _class.$$componentPath = "_components/keyboard/index", _temp2);
