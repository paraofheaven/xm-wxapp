...
var MyIcon = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(MyIcon, [{
    ...
    value: function _constructor() {
      _get(MyIcon.prototype.__proto__ || Object.getPrototypeOf(MyIcon.prototype), "_constructor", this).apply(this, arguments);
      this.defaultProps = {
        value: '',
        size: 16,
        color: '',
    ...
    key: "funPrivatelmspR",
    value: function funPrivatelmspR() {
      return this.props.onClick.apply(undefined, Array.prototype.slice.call(arguments, 1));
    }
  }]);

  return MyIcon;
}(_index.Component), _class.$$events = ["funPrivatelmspR"], _class.$$componentPath = "_components/myicon/index", _temp2);
