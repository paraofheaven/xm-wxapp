...
var NoticeBar = (_temp2 = _class = function (_BaseComponent) {
  ...
  function NoticeBar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = NoticeBar.__proto__ || Object.getPrototypeOf(NoticeBar)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "$compid__7", "$compid__8", "visible", "animationData", "closable", "duration", "delay", "loop", "children"], _this.initAnimation = function () {
  ...
  _createClass(NoticeBar, [{
    ...
    value: function _createData() {
      ...
      closable && _index.propsManager.set($props__8, $compid__8);
