...
var OtpModal = (_temp2 = _class = function (_BaseComponent) {
  ...
  function OtpModal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OtpModal.__proto__ || Object.getPrototypeOf(OtpModal)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp3", "loopArray3", "$compid__32", "$compid__33", "$compid__34", "codeNumbers", "codeValue", "btnDisabled", "btnLoading", "title", "desc", "isOpen", "closeOnClickOverlay", "color", "onSendRequest", "__fn_call"], _this.clearInputState = function () {
      _this.setState({
  ...
  _createClass(OtpModal, [{
    ...
    value: function _createData() {
      ...
      var loopArray3 = codeNumbers.map(function (item, _anonIdx) {
        item = {
