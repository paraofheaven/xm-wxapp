...
var PwdBox = (_temp2 = _class = function (_BaseComponent) {
  ...
  function PwdBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PwdBox.__proto__ || Object.getPrototypeOf(PwdBox)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["title", "subTitle", "pwdNumbers", "pwdValue", "showForgetPwd", "forgetPwdText", "__fn_call", "forgetPwdLink"], _this.onPwdInput = function (e) {
